// Script para corrigir encoding UTF-8 no GitHub via API
import { githubStorageV2 } from './src/services/github-storage-v2.js'
...
console.log("Dados corretos preparados.")
console.log("Execute o comando a seguir para aplicar no GitHub:")
console.log("node -e \"")
console.log("const fs = require('fs');")
console.log("const data = `" + correctData.replace(/`/g, '\\`') + "`;")
console.log("fs.writeFileSync('./temp-fix.ts', data);")
console.log("console.log('Arquivo temporário criado. Agora copie o conteúdo para o GitHub manualmente.');")
console.log("\"")