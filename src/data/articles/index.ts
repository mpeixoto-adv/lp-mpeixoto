  ...
  export const articlesMetadata: ArticleMetadata[] = [
    {
      ...
      excerpt: "A LGPD trouxe mudanças significativas para o tratamento de dados pessoais. Entenda 
  as principais obrigações e como se adequar.",
    ...
    },
    {
      ...
      excerpt: "Conheça seus direitos ao realizar compras pela internet e saiba como se proteger de
   fraudes e problemas.",
    ...
    },
    {
      ...
      excerpt: "Entenda as principais mudanças da reforma tributária e como elas afetarão o dia a 
  dia das pequenas e médias empresas.",
